    ...
    <div class="jumbotron">
     ...
     <img src="img/buku31.jpg">   
      ...
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        <h2><b>Selamat datang di toko Burung Kicau Kami.<h1 style="color:#f97b61;">Dodol<b>BUKU.pol</b></h1></h2>
        <p>disini anda bisa membeli dan memesan burung kicau dengan mudah, anda tinggal klik, maka burung kicau sampai di tempat anda. tidak perlu lagi jauh jauh ke peternakan.</p>
      </div>
    </div>
    </div>
...
Cara Pesan
   ...
   <div class="footer" style="width:100%;height:270px;color:#fff;background:#d74b35;">
      ...
      <div style="margin:50px;height:120px;">
        ...
        <center>&copy; 2020 Karya Wrsrad45.</center>
        </div>
      </div>
  </body>
</html>
